...
class RecommandedItemDetails extends StatefulWidget {
  final int pageId;
  final String page;
  const RecommandedItemDetails({
    Key? key,
  ...
  @override
  State<RecommandedItemDetails> createState() => _RecommandedItemDetailsState();
}

class _RecommandedItemDetailsState extends State<RecommandedItemDetails> {
  ...
  Widget build(BuildContext context) {
    var product =
        Get.find<InventoryRecommendedController>().recommendedProductList[widget.pageId];
