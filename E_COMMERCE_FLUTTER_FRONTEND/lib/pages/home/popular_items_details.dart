...
class PopularItemDetails extends StatefulWidget {
  final int pageId;
  final String page;
  ...
  @override
  State<PopularItemDetails> createState() => _PopularItemDetailsState();
}

class _PopularItemDetailsState extends State<PopularItemDetails> {
  ...
  Widget build(BuildContext context) {
    var product = Get.find<InventoryPopularController>()
                              ...
                              if (_userhasLoggedIn) {
                                if (cartController.getCurrentQuantity == 0) {
                                  Get.snackbar("Zero Quantity",
                                      "You Cant't Add Product In Cart With Zero Quantity",backgroundColor: Colors.pink,colorText: Colors.white);
